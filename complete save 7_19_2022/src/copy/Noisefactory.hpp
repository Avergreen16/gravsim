...
struct PerlinNoiseFactory {
    ...
    void set_parameters(double p_seed, double p_factor, int p_width, int p_height, double p_scale, int p_octaves, double p_persistance, bool p_loop_x, bool p_loop_y, double p_multiplier=1, double p_offset=0);
